...
class Type3Composer extends zk.grails.Composer {
       ...
       $('#2').on('click',{
        ...
        $('#cal1').on('click',{
            ...
            if($('#volts').text() == "แรงดัน 69 กิโลโวลต์ ขึ้นไป"){
            	...
            	Float y = Float.valueOf($('#sumvolts').val());
            	...
            	Float a = Float.valueOf(xxx*175.70);
                ...
                Float f = Float.valueOf((yyy*58.96)/100);
                ...
                Float a = Float.valueOf(xxx*196.26);
                String aa = String.format("%.2f", a);
                Float aaa = Float.valueOf(aa);
                ...
                Float a = Float.valueOf(xxx*221.50);
                String aa = String.format("%.2f", a);
                Float aaa = Float.valueOf(aa);
